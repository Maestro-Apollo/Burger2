...
class profile extends database
{
    ...
    public function foodFunction()
    {
        if (isset($_POST['search'])) {
            ...
            $sql = "SELECT * FROM `food_tbl` WHERE category = 'side' AND food_name like '$product%' ";
        } else {
            $sql = "SELECT * FROM `food_tbl` WHERE category = 'side'";
        }
...
<body class="bg-light">
    ...
    <section>
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                    <h3 class="font-weight-bold" style="color: #481639">Sides</h3>
                    ...
                    <div class="account bg-white mt-5 p-5 rounded">
                        ...
                        <div class="container">
                            ...
                            <form action="" method="post">
                                <a href="side.php" class="mr-3"><i class="fas fa-sync-alt"></i>
                                </a>
                            ...
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if (strcmp($row['sub_category'], 'fries') == 0) { ?>
                                ...
                                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if (strcmp($row['sub_category'], 'wings') == 0) { ?>
                                        <div class="col-md-5  shadow p-5 mb-5">
                                            <img src="images/<?php echo $row['image']; ?>" class="img-fluid" alt="">
                                            <input type="hidden" name="sub_cat"
                                                value="<?php echo $row['sub_category']; ?>">
                                ...
                                <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <?php if (strcmp($row['sub_category'], 'rings') == 0) { ?>
                                        <div class="col-md-5  shadow p-5 mb-5">
                                            <img src="images/<?php echo $row['image']; ?>" class="img-fluid" alt="">
                                            <input type="hidden" name="sub_cat"
                                                value="<?php echo $row['sub_category']; ?>">
